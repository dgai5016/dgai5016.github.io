        ...
        <ul class="nav-list">
          <li v-for="item in nav" :key="item.link">
            ...
            >
              ...
              <!-- 地图：折叠地图图标（Heroicons 线性风格，与首页/归档/书单一致） -->
              <span v-else-if="item.text === '地图'">
                <svg class="nav-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 20l-5.447-2.724A1 1 0 014 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l4.553 2.276A1 1 0 0021 18.382V7.618a1 1 0 00-.553-.894L15 4m0 13V4m0 0L9 7" /></svg>
              </span>
              <!-- 书单：书本图标（Heroicons 线性风格，与首页/归档一致） -->
              <span v-else-if="item.text === '书单'">
      ...
      <ul class="nav-list">
        <li v-for="item in nav" :key="item.link">
          ...
          >
            ...
            <!-- 地图：折叠地图图标（Heroicons 线性风格，与桌面端一致） -->
            <span v-else-if="item.text === '地图'">
              <svg class="nav-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 20l-5.447-2.724A1 1 0 014 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l4.553 2.276A1 1 0 0021 18.382V7.618a1 1 0 00-.553-.894L15 4m0 13V4m0 0L9 7" /></svg>
            </span>
            <!-- 书单：书本图标（Heroicons 线性风格，与首页/归档一致） -->
