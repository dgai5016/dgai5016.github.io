...
Ready to start building with MCP? Choose your path:
  ...
  - [Build a Server](https://modelcontextprotocol.io/docs/2026-07-28/develop/build-server)：Learn how to create your first MCP server
  - [Build a Client](https://modelcontextprotocol.io/docs/2026-07-28/develop/build-client)：Create applications that connect to MCP servers
