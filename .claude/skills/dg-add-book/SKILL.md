...
12. **process-cover.py 的入库路径是相对 cwd 的**：跑它前必须 `cd` 到博客仓库根，否则封面落进 `docs/books/docs/public/...` 双层目录、页面 404（2026-09 加《学习觉醒》踩过：cwd 停在 docs/books）；跑完 `ls docs/public/covers/books/<slug>*` 确认两份都在再进 Step 5
